...
import com.tdev.winltr.container.Container;
import com.tdev.winltr.xenvironment.ImageFs;
import com.tdev.winltr.xenvironment.XEnvironment;
import com.tdev.winltr.xenvironment.components.GuestProgramLauncherComponent;
...
public abstract class WineUtils {
    public static void createDosdevicesSymlinks(Container container) {
        ...
        for (String[] drive : container.drivesIterator()) {
            ...
            if (!linkTarget.isDirectory() && path.endsWith("/com.tdev.winltr/storage")) {
                linkTarget.mkdirs();
